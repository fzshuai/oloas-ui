  ...
  <div class="app-container">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          v-if="userDialogTitle === '委派任务'"
          @click="submitDelegate"
          >确 定</el-button
        >
        <el-button
          type="primary"
          v-if="userDialogTitle === '转办任务'"
...
export default {
  ...
  created() {
    ...
    this.taskForm.definitionId =
      this.$route.query && this.$route.query.definitionId;
      ...
      return new Promise((resolve) => {
        getFlowViewer(procInsId).then((res) => {
          ...
          if (data) {
            ...
            this.finishedInfo.finishedSequenceFlowSet =
              data.finishedSequenceFlowSet;
          }
          resolve();
        });
      });
