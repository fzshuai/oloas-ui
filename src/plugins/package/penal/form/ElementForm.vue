<template>
  <div class="panel-tab__content">
    ...
    <div class="element-property list-property">
      ...
      <el-table :data="fieldList" size="mini" max-height="240" it>
    ...
    <el-drawer :visible.sync="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <template v-if="formFieldForm.type === 'enum'">
        ...
        <el-table :data="fieldEnumList" size="mini" key="enum-table" max-height="240" fit>
      ...
      <el-table :data="fieldConstraintsList" size="mini" key="validation-table" max-height="240" fit>
        <el-table-column label="序号" width="50px" type="index" />
      ...
      <el-table :data="fieldPropertiesList" size="mini" key="property-table" max-height="240" it>
        <el-table-column label="序号" width="50px" type="index" />
